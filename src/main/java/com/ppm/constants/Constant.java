package com.ppm.constants;

/**
 * @ClassName: Constant
 * TODO:类文件简单描述
 * @Author: changguangqi
 * @CreateDate: 2020/05/04 23:30
 * @UpdateUser: changguangqi
 * @UpdateDate: 2020/05/04 23:30
 * @Version: 0.0.1
 */
public class Constant {
     ...
     * 用户权鉴缓存 key
     */
    public static final String IDENTIFY_CACHE_KEY="shiro-cache:com.ppm.shiro.CustomRealm.authorizationCache:";

    public static final String MEMBER="member";

    public static final String ONLINE_WX_MEMBER="onelineWxMember";
}
