...
import com.ppm.mapper.SysPermissionMapper;
 ...
 * TODO:类文件简单描述
 * @Author: changguangqi
 * @CreateDate: 2020/05/04 11:40
 * @UpdateUser: changguangqi
 * @UpdateDate: 2020/05/04 11:40
 * @Version: 0.0.1
 */
@Service
@Slf4j
public class PermissionServiceImpl implements PermissionService {
     ...
     * @Version:     0.0.1
     * @param userId
     * @return       java.util.List<.entity.SysPermission>
     * @throws
     */
    @Override
     ...
     * @Version:     0.0.1
     * @param vo
     * @return       .vo.resp.PageVO<.entity.SysPermission>
     * @throws
     */
    @Override
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5  10:53
     * @UpdateUser:
     * @UpdateDate:  2020/5/5  10:53
     * @Version:     0.0.1
     * @param userId
     * @return       java.util.List<.vo.resp.PermissionRespNode>
     * @throws
     */
    @Override
