 ...
 * TODO:类文件简单描述
 * @Author: changguangqi
 * @CreateDate: 2020/05/04 13:47
 * @UpdateUser: changguangqi
 * @UpdateDate: 2020/05/04 13:47
 * @Version: 0.0.1
 */
@Service
public class RedisService {
     ...
     * 删除key
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:25
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:25
     * @Version:     0.0.1
     * @param key
     ...
     * 批量删除key
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:27
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:27
     * @Version:     0.0.1
     * @param keys
     ...
     * 是否存在key
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:30
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:30
     * @Version:     0.0.1
     * @param key
     ...
     * 设置过期时间
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:35
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:35
     * @Version:     0.0.1
     * @param key
     * @param timeout
     * @param unit
     ...
     * 查找匹配的key
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:38
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:38
     * @Version:     0.0.1
     * @param pattern
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:41
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:41
     * @Version:     0.0.1
     * @param key
     * @return       java.lang.Boolean
     * @throws
     ...
     * 返回 key 的剩余的过期时间
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:43
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:43
     * @Version:     0.0.1
     * @param key
     * @param unit
     ...
     * 设置指定 key 的值
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:50
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:50
     * @Version:     0.0.1
     * @param key
     * @param value
     * @return       void
     ...
     * 设置key 的值 并设置过期时间
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 20:55
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 20:55
     * @Version:     0.0.1
     * @param key
     * @param value
     * @param time
     ...
     * key不存在设置值返回true
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 21:05
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 21:05
     * @Version:     0.0.1
     * @param key
     * @param value
     * @param time
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 21:15
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 21:15
     * @Version:     0.0.1
     * @param key
     * @param value
     * @return       java.lang.Object
     ...
     * 通过批量的key获取批量的value
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 21:20
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 21:20
     * @Version:     0.0.1
     * @param keys
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 21:25
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 21:25
     * @Version:     0.0.1
     * @param key
     * @param increment
     * @return       long
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 21:30
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 21:30
     * @Version:     0.0.1
     * @param key
     * @param decrement
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 21:35
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 21:35
     * @Version:     0.0.1
     * @param key
     * @param value
...
//******************hash数据类型*********************
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 22:35
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 22:35
     * @Version:     0.0.1
     * @param key
     * @param field
     * @return       java.lang.Object
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 22:39
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 22:39
     * @Version:     0.0.1
     * @param key
     * @param field
     * @param value
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 22:41
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 22:41
     * @Version:     0.0.1
     * @param key
     * @param field
     * @return       java.lang.Boolean
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 22:45
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 22:45
     * @Version:     0.0.1
     * @param key
     * @param fields
     * @return       java.lang.Long
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 22:50
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 22:50
     * @Version:     0.0.1
     * @param key
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 22:55
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 22:55
     * @Version:     0.0.1
     * @param key
     * @param hash
     * @return
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 22:59
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 22:59
     * @Version:     0.0.1
     * @param key
     * @param fields
     * @return       java.util.List<java.lang.Object>
     ...
     * 对应key的字段自增相应的值
     * @Author:      changguangqi
     * @CreateDate:   2020/5/5 23:03
     * @UpdateUser:
     * @UpdateDate:   2020/5/5 23:03
     * @Version:     0.0.1
     * @param key
     * @param field
     * @param increment
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 23:23
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 23:23
     * @Version:     0.0.1
     * @param key
     ...
     * 如果该键的Value不是链表类型，该命令将将会抛出相关异常。操作成功则返回插入后链表中元素的数量。
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 23:26
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 23:26
     * @Version:     0.0.1
     * @param key
     * @param strs 可以使一个string 也可以使string数组
     * @return       java.lang.Long 返回操作的value个数
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 23:29
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 23:29
     * @Version:     0.0.1
     * @param key
     * @return       java.lang.Object
     * @throws
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 23:33
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 23:33
     * @Version:     0.0.1
     * @param key
     * @return       java.lang.Object
     * @throws
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 23:38
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 23:38
     * @Version:     0.0.1
     * @param key
     * @param start
     * @param end
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 23:43
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 23:43
     * @Version:     0.0.1
     * @param key
     * @param start
     * @param end
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 23:48
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 23:48
     * @Version:     0.0.1
     * @param key
     * @param index
     * @return       java.lang.Object
     ...
     * @Author:      changguangqi
     * @CreateDate:  2020/5/5 23:51
     * @UpdateUser:
     * @UpdateDate:  2020/5/5 23:51
     * @Version:     0.0.1
     * @param key
     * @return       java.lang.Long
     * @throws
     ...
     * @param params
     */
    public void setHashAll(String key,Map<?,?> params,Integer time,TimeUnit unit){
     ...
     * @param list
     */
    public synchronized Long setList(String key,List list,Integer time,TimeUnit unit){
        if(getList(key).size()!=0){
            return 0l;
        }
        Long code = redisTemplate.opsForList().rightPushAll(key, list);
        redisTemplate.expire(key,time,unit);
        return code;
    }
     ...
     * @param value
     * @param time 时长
     * @param unit 时间单位 TimeUnit.HOURS  SECOND
     */
